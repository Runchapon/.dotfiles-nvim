...
vim.api.nvim_create_autocmd({ "ColorScheme", "VimEnter" }, {
	...
	callback = function()
		...
		if vim.g.transparent_enabled then
			...
			vim.api.nvim_set_hl(0, "FloatTitle", { bg = "#000000" })
			vim.api.nvim_set_hl(0, "FloatBorder", { bg = "#000000" })
			vim.api.nvim_set_hl(0, "FloatShadow", { bg = "#000000" })
		end
		vim.api.nvim_set_hl(0, "MiniCursorWord", { bg = "#454f77", underline = true})
		vim.api.nvim_set_hl(0, "MiniCursorWordCurrent", { bg = "#454f66", underline = true, bold = true})
	end,
})
